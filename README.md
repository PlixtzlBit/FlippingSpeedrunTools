...
2. Then go into BepInEx > Plugins > and make a new folder named FlippingSpeedrunTools then put the dll file inside there. (If you installed this mod already but want to upate it just remove the old .dll file)
