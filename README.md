...
4. Run the game again and you will have the mod. Hold L for one second while in a run to enable the mods. You can look at your Flipping is Hard folder for a file named `ControlsPreset.txt` to see the controls or change them if you want to.

Important: If it doesn't work, then if you don't see a black window appear before the game then you didn't put BepInEx in properly. If you do but the mod doesn't work, or the mod doesn't create a ControlsPreset.txt, you didn't put the mod into the plugins correctly.
